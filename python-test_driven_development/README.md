...
[![TDD Meme](https://s3.eu-west-3.amazonaws.com/hbtn.intranet.project.files/holbertonschool-higher-level_programming+/246/giphy-4.gif)](#)
...
- **All your modules should have a documentation** (example: `python3 -c 'print(__import__("my_module").__doc__)'`)
- **All your functions should have a documentation** (example: `python3 -c 'print(__import__("my_module").my_function.__doc__)'`)
